                            ...
                            <div class="product-view-area">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-5 col-md-6">
                                        <div class="part-img mr-30">
                                            <div class="img-box" id="bigPreview">
                                                <img src="assets/images/c870x524 (14).web.webp" alt="Image" style="width: 100%;">
                                    ...
                                    <div class="col-xl-6 col-lg-7 col-md-6">
                                        <div class="part-txt">
                                            <h2 class="main-product-title">CrossTown Fitness Classes</h2>
                                            <div class="review">
                                                <span class="star">
                                                    <i class="fa-solid fa-star-sharp rated"></i>
                                                    <i class="fa-solid fa-star-sharp rated"></i>
                                            ...
                                            <p class="dscr">CrossTown Fitness Classes</p>
                                            <form>
